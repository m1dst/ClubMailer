                    ...
                    using (var csv = new CsvReader(reader))
                    {
                        ...
                        var smtpClient = new SmtpClient(Environment.GetEnvironmentVariable("SmtpServer"))
                        {
                            ...
                            Credentials = new NetworkCredential(
                                Environment.GetEnvironmentVariable("SmtpServerUsername"),
                                Environment.GetEnvironmentVariable("SmtpServerPassword")),
                            EnableSsl = true,
                        };
                        ...
                        members.ForEach(member =>
                        {
                            try
                            {
                                ...
                                {
                                    msg.Subject += " - Your membership has expired!";
                                }
